...
import com.kubeiwu.commontool.view.pulltorefresh.listview.KListViewFooter;
import com.kubeiwu.commontool.view.pulltorefresh.listview.KListViewHeader;

/**
 * @author cgpllx1@qq.com (www.kubeiwu.com)
 * @date 2014-7-29
 */
public class KGridView extends HeaderFooterGridView implements OnScrollListener {
	...
	private void initWithContext(Context context, KConfig config) {
		...
		// KListView need the scroll event, and it will dispatch the event to
