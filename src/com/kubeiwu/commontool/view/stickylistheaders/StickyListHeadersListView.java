package com.kubeiwu.commontool.view.stickylistheaders;
...
public class StickyListHeadersListView extends FrameLayout {
	...
	private void updateOrClearHeader(int firstVisiblePosition) {
		...
		final boolean isFirstViewBelowTop = doesListHaveChildren && mList.getFirstVisiblePosition() == 0 && mList.getChildAt(0).getTop() > 0;
	...
	public void setXListViewListener(IKListViewListener l) {
		mList.setKListViewListener(l);
	}

	public void setPullRefreshEnable(boolean enable) {
		mList.setPullRefreshEnable(enable);
	}
