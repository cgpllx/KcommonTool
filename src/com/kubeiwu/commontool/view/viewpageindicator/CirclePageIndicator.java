package com.kubeiwu.commontool.view.viewpageindicator;
...
public class CirclePageIndicator extends View implements PageIndicator {
	...
	private final Paint mPaintPageFill = new Paint(ANTI_ALIAS_FLAG);//默认背景
	private final Paint mPaintStroke = new Paint(ANTI_ALIAS_FLAG);//边缘颜色
	private final Paint mPaintFill = new Paint(ANTI_ALIAS_FLAG);//被选择的背景
	...
	public CirclePageIndicator(Context context, AttributeSet attrs, int defStyle) {
		...
		if (isInEditMode())
			return;
		//设置默认属性
		final int defaultPageColor = 0x64FFFFFF;
		final int defaultFillColor = 0xFFFFFFFF;
		final int defaultOrientation = 0;
		final int defaultStrokeColor = 0x00000000;
		final float defaultStrokeWidth = 0;//边缘宽
	...
	protected void onDraw(Canvas canvas) {
		...
		final float threeRadius = (interspace == 0) ? mRadius * 3 : interspace;
