 ...
 * be ignored, the caller may use {@code hasUnterminatedLine()} to detect it
 * after catching the {@code EOFException}.
 * 
 * <p>
 ...
 * charset is one of US-ASCII, UTF-8 and ISO-8859-1. The default charset is
 * US_ASCII.
 */
class StrictLineReader implements Closeable {
	 ...
	 * <= pos <= end and the data in the range [pos, end) is buffered for
	 * reading. At end of input, if there is an unterminated line, we set end ==
	 * -1, otherwise end == pos. If the underlying {@code InputStream} throws an
	 ...
	 * @param charset
	 *            the charset used to decode data. Only US-ASCII, UTF-8 and
	...
	/**
	 * Constructs a new {@code LineReader} with the specified capacity and
	 * charset.
	 * 
	 * @param in
	 *            the {@code InputStream} to read data from.
	 ...
	 *             if {@code in} or {@code charset} is null.
	 * @throws IllegalArgumentException
	 *             if {@code capacity} is negative or zero or the specified
