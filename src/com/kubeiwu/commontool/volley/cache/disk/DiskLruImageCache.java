package com.kubeiwu.commontool.volley.cache.disk;
...
import com.kubeiwu.commontool.BuildConfig;
import com.kubeiwu.commontool.volley.cache.disk.util.DiskLruCache;
...
public class DiskLruImageCache  {
	...
	public DiskLruImageCache(Context context, String uniqueName, int diskCacheSize) {
		try {
			final File diskCacheDir = getDiskCacheDir(context, uniqueName);
			mDiskCache = DiskLruCache.open(diskCacheDir, APP_VERSION, VALUE_COUNT, diskCacheSize);
			System.out.println(mDiskCache.getDirectory().getPath());
		} catch (IOException e) {
			e.printStackTrace();
		}
	}
	...
	private File getDiskCacheDir(Context context, String uniqueName) {
		...
		System.out.println("地址" + new File(cachePath + File.separator + uniqueName));
